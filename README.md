...
### Latest version: 0.4.18 (build 40)

Released August 13, 2026 · [What's new](https://orchestris.com/docs/release-notes)

| Platform | Download & install | Size |
| --- | --- | --- |
| **Windows**<br><sub>Windows 10</sub> | [orchestris-chat-windows-x64-0.4.18-40-setup.exe](https://github.com/Orchestris-Inc/orchestris/releases/download/client-v0.4.18-40/orchestris-chat-windows-x64-0.4.18-40-setup.exe)<br><br><sub>After downloading, double-click the .exe and follow the setup wizard.</sub> | 22 MB |
| **macOS**<br><sub>macOS 11 (Apple silicon)</sub> | [orchestris-chat-macos-arm64-0.4.18-40.pkg](https://github.com/Orchestris-Inc/orchestris/releases/download/client-v0.4.18-40/orchestris-chat-macos-arm64-0.4.18-40.pkg)<br><br><sub>After downloading, double-click the .pkg and follow the installer.</sub> | 41 MB |
