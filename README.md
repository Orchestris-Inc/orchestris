...
| Platform | Download | Size |
| --- | --- | --- |
| **Windows** | [Orchestris-Setup-0.8.14-windows-x64.exe](https://github.com/Orchestris-Inc/orchestris/releases/download/server-community-v0.8.14/Orchestris-Setup-0.8.14-windows-x64.exe) | 233 MB |
...
<sub>[Checksums](https://github.com/Orchestris-Inc/orchestris/releases/download/server-community-v0.8.14/SHA256SUMS.txt) · [Linux signing key](https://github.com/Orchestris-Inc/orchestris/releases/download/server-community-v0.8.14/orchestris-linux-release-key.asc) · [All files for this release](https://github.com/Orchestris-Inc/orchestris/releases/tag/server-community-v0.8.14)</sub>
